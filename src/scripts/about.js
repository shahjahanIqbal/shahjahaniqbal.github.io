...
`;   
    ...
    const term = $('#term').terminal(commands, {
            greetings: "Hello mortal.. I sense that you seek knowledge about me. \nEnter [[;#fbb34d;]help] to know the list of commands. But be warned.. there are plenty more spells hidden \nfrom your sights. The legends call them the eggs of easter. You must seek them out yourself.",
            keepWords: true,
            prompt: '>>>',
    });
